...
(
   ...
   (
      ...
      // AVM avm_local_bb3_ld__pre_pre_inst0
      .avm_local_bb3_ld__pre_pre_inst0_read(avm_kernel_rd_read[1]),
      .avm_local_bb3_ld__pre_pre_inst0_write(avm_kernel_rd_write[1]),
      .avm_local_bb3_ld__pre_pre_inst0_burstcount(avm_kernel_rd_burstcount[1]),
      .avm_local_bb3_ld__pre_pre_inst0_address(avm_kernel_rd_address[1]),
      .avm_local_bb3_ld__pre_pre_inst0_writedata(avm_kernel_rd_writedata[1]),
      .avm_local_bb3_ld__pre_pre_inst0_byteenable(avm_kernel_rd_byteenable[1]),
      .avm_local_bb3_ld__pre_pre_inst0_waitrequest(avm_kernel_rd_waitrequest[1]),
      .avm_local_bb3_ld__pre_pre_inst0_readdata(avm_kernel_rd_readdata[1]),
      .avm_local_bb3_ld__pre_pre_inst0_readdatavalid(avm_kernel_rd_readdatavalid[1]),
      .avm_local_bb3_ld__pre_pre_inst0_writeack(avm_kernel_rd_writeack[1]),
      // AVM avm_local_bb5_st__pre_pre_inst0
      .avm_local_bb5_st__pre_pre_inst0_read(avm_kernel_wr_read[0]),
      .avm_local_bb5_st__pre_pre_inst0_write(avm_kernel_wr_write[0]),
      .avm_local_bb5_st__pre_pre_inst0_burstcount(avm_kernel_wr_burstcount[0]),
      .avm_local_bb5_st__pre_pre_inst0_address(avm_kernel_wr_address[0]),
      .avm_local_bb5_st__pre_pre_inst0_writedata(avm_kernel_wr_writedata[0]),
      .avm_local_bb5_st__pre_pre_inst0_byteenable(avm_kernel_wr_byteenable[0]),
      .avm_local_bb5_st__pre_pre_inst0_waitrequest(avm_kernel_wr_waitrequest[0]),
      .avm_local_bb5_st__pre_pre_inst0_readdata(avm_kernel_wr_readdata[0]),
      .avm_local_bb5_st__pre_pre_inst0_readdatavalid(avm_kernel_wr_readdatavalid[0]),
      .avm_local_bb5_st__pre_pre_inst0_writeack(avm_kernel_wr_writeack[0]),
      // AVM avm_local_bb6_ld__inst0
      .avm_local_bb6_ld__inst0_read(avm_kernel_rd_read[2]),
      .avm_local_bb6_ld__inst0_write(avm_kernel_rd_write[2]),
      .avm_local_bb6_ld__inst0_burstcount(avm_kernel_rd_burstcount[2]),
      .avm_local_bb6_ld__inst0_address(avm_kernel_rd_address[2]),
      .avm_local_bb6_ld__inst0_writedata(avm_kernel_rd_writedata[2]),
      .avm_local_bb6_ld__inst0_byteenable(avm_kernel_rd_byteenable[2]),
      .avm_local_bb6_ld__inst0_waitrequest(avm_kernel_rd_waitrequest[2]),
      .avm_local_bb6_ld__inst0_readdata(avm_kernel_rd_readdata[2]),
      .avm_local_bb6_ld__inst0_readdatavalid(avm_kernel_rd_readdatavalid[2]),
      .avm_local_bb6_ld__inst0_writeack(avm_kernel_rd_writeack[2]),
      ...
      .avm_local_bb8_st__inst0_read(avm_kernel_wr_read[2]),
      .avm_local_bb8_st__inst0_write(avm_kernel_wr_write[2]),
      .avm_local_bb8_st__inst0_burstcount(avm_kernel_wr_burstcount[2]),
      .avm_local_bb8_st__inst0_address(avm_kernel_wr_address[2]),
      .avm_local_bb8_st__inst0_writedata(avm_kernel_wr_writedata[2]),
      .avm_local_bb8_st__inst0_byteenable(avm_kernel_wr_byteenable[2]),
      .avm_local_bb8_st__inst0_waitrequest(avm_kernel_wr_waitrequest[2]),
      .avm_local_bb8_st__inst0_readdata(avm_kernel_wr_readdata[2]),
      .avm_local_bb8_st__inst0_readdatavalid(avm_kernel_wr_readdatavalid[2]),
      .avm_local_bb8_st__inst0_writeack(avm_kernel_wr_writeack[2])
   );
...
(
   ...
   // AVM avm_local_bb3_ld__pre_pre_inst0
   output logic avm_local_bb3_ld__pre_pre_inst0_read,
   output logic avm_local_bb3_ld__pre_pre_inst0_write,
   output logic [4:0] avm_local_bb3_ld__pre_pre_inst0_burstcount,
   output logic [29:0] avm_local_bb3_ld__pre_pre_inst0_address,
   output logic [255:0] avm_local_bb3_ld__pre_pre_inst0_writedata,
   output logic [31:0] avm_local_bb3_ld__pre_pre_inst0_byteenable,
   input logic avm_local_bb3_ld__pre_pre_inst0_waitrequest,
   input logic [255:0] avm_local_bb3_ld__pre_pre_inst0_readdata,
   input logic avm_local_bb3_ld__pre_pre_inst0_readdatavalid,
   input logic avm_local_bb3_ld__pre_pre_inst0_writeack,
   // AVM avm_local_bb5_st__pre_pre_inst0
   output logic avm_local_bb5_st__pre_pre_inst0_read,
   output logic avm_local_bb5_st__pre_pre_inst0_write,
   output logic [4:0] avm_local_bb5_st__pre_pre_inst0_burstcount,
   output logic [29:0] avm_local_bb5_st__pre_pre_inst0_address,
   output logic [255:0] avm_local_bb5_st__pre_pre_inst0_writedata,
   output logic [31:0] avm_local_bb5_st__pre_pre_inst0_byteenable,
   input logic avm_local_bb5_st__pre_pre_inst0_waitrequest,
   input logic [255:0] avm_local_bb5_st__pre_pre_inst0_readdata,
   input logic avm_local_bb5_st__pre_pre_inst0_readdatavalid,
   input logic avm_local_bb5_st__pre_pre_inst0_writeack,
   // AVM avm_local_bb6_ld__inst0
   ...
   output logic [29:0] avm_local_bb8_st__inst0_address,
   output logic [255:0] avm_local_bb8_st__inst0_writedata,
   output logic [31:0] avm_local_bb8_st__inst0_byteenable,
   input logic avm_local_bb8_st__inst0_waitrequest,
   input logic [255:0] avm_local_bb8_st__inst0_readdata,
   ...
   (
      ...
      // AVM avm_local_bb3_ld__pre_pre_inst0
      .avm_local_bb3_ld__pre_pre_inst0_read(avm_local_bb3_ld__pre_pre_inst0_read),
      .avm_local_bb3_ld__pre_pre_inst0_write(avm_local_bb3_ld__pre_pre_inst0_write),
      .avm_local_bb3_ld__pre_pre_inst0_burstcount(avm_local_bb3_ld__pre_pre_inst0_burstcount),
      .avm_local_bb3_ld__pre_pre_inst0_address(avm_local_bb3_ld__pre_pre_inst0_address),
      .avm_local_bb3_ld__pre_pre_inst0_writedata(avm_local_bb3_ld__pre_pre_inst0_writedata),
      .avm_local_bb3_ld__pre_pre_inst0_byteenable(avm_local_bb3_ld__pre_pre_inst0_byteenable),
      .avm_local_bb3_ld__pre_pre_inst0_waitrequest(avm_local_bb3_ld__pre_pre_inst0_waitrequest),
      .avm_local_bb3_ld__pre_pre_inst0_readdata(avm_local_bb3_ld__pre_pre_inst0_readdata),
      .avm_local_bb3_ld__pre_pre_inst0_readdatavalid(avm_local_bb3_ld__pre_pre_inst0_readdatavalid),
      .avm_local_bb3_ld__pre_pre_inst0_writeack(avm_local_bb3_ld__pre_pre_inst0_writeack),
      // AVM avm_local_bb5_st__pre_pre_inst0
      .avm_local_bb5_st__pre_pre_inst0_read(avm_local_bb5_st__pre_pre_inst0_read),
      .avm_local_bb5_st__pre_pre_inst0_write(avm_local_bb5_st__pre_pre_inst0_write),
      .avm_local_bb5_st__pre_pre_inst0_burstcount(avm_local_bb5_st__pre_pre_inst0_burstcount),
      .avm_local_bb5_st__pre_pre_inst0_address(avm_local_bb5_st__pre_pre_inst0_address),
      .avm_local_bb5_st__pre_pre_inst0_writedata(avm_local_bb5_st__pre_pre_inst0_writedata),
      .avm_local_bb5_st__pre_pre_inst0_byteenable(avm_local_bb5_st__pre_pre_inst0_byteenable),
      .avm_local_bb5_st__pre_pre_inst0_waitrequest(avm_local_bb5_st__pre_pre_inst0_waitrequest),
      .avm_local_bb5_st__pre_pre_inst0_readdata(avm_local_bb5_st__pre_pre_inst0_readdata),
      .avm_local_bb5_st__pre_pre_inst0_readdatavalid(avm_local_bb5_st__pre_pre_inst0_readdatavalid),
      .avm_local_bb5_st__pre_pre_inst0_writeack(avm_local_bb5_st__pre_pre_inst0_writeack),
      // AVM avm_local_bb6_ld__inst0
